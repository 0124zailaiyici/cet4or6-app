...
function scoreWritingLocal(text, prompt, reference) {
...
Page({
    ...
    onLoad() {
        ...
        this.setData({
            patterns: sentence_patterns_1.default,
            writings: writings_1.default,
    ...
    setToolkitCategory(e) {
        this.setData({ toolkitCategory: e.currentTarget.dataset.cat });
    },
    onToolkitSearch(e) {
