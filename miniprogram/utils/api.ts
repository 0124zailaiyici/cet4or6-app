// 部署到公网后改成你的服务器地址：
// wx.setStorageSync('api_base', 'https://47.106.126.50/cet4')
const API_BASE = (() => { try { return wx.getStorageSync('api_base') || 'https://47.106.126.50/cet4' } catch(_) { return 'https://47.106.126.50/cet4' } })()
